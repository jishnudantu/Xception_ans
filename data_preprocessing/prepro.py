...
def get_unqiue_img(imgs):
    ...
    unique_img = ['/home/ubuntu/data/'+i for i in unique_img]
...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_train_json', default='/home/ubuntu/data/questions_annotations/vqa_raw_train.json', help='input json file to process into hdf5')
    parser.add_argument('--input_test_json', default= '/home/ubuntu/data/questions_annotations/vqa_raw_test.json', help='input json file to process into hdf5')
